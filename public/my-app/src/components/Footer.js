...
//     <div style={{position:"relative",bottom:"0px",marginTop:"0px",height:"35px",width:"100%",backgroundColor:"#d1e0e0",color:"black",display:"flex",justifyContent:"center",alignItems:"center",zIndex:"11"}}> 
...
//     </div>
//     <div style={{position:"relative",bottom:"0px",height:"35px",width:"100%",backgroundColor:"#d1e0e0",display:"flex",justifyContent:"center",alignItems:"center",zIndex:"10"}}>
...
export default function Footer() {
  return (
    <>
      ...
      <div className="relative bottom-0 mt-0 h-[35px] w-full bg-[#d1e0e0] text-black flex justify-center items-center z-[11]">
      ...
      <div className="relative bottom-0 h-[35px] w-full bg-[#d1e0e0] flex justify-center items-center z-[10]">
